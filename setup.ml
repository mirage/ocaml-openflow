...
(* OASIS_START *)
(* DO NOT EDIT (digest: 525463d80a0b3fbee13d1e34a1eb8ac7) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ofcontroller"; "Ofpacket"; "Ofswitch"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\193\248\239t\225\166Ib;E\202\158*j\241\245";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
