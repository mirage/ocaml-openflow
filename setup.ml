...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa33cb6e35d8a7dd7c7a216898ad087a) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "openflow_net_lwt";
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cstruct", None);
                           FindlibPackage ("cstruct.syntax", None);
                           InternalLibrary "openflow_net_lwt"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "C\021H\210\201c2\133\232\250\208\000\020'\158\175";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
