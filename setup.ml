...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1033104fff2e209126c1aa21ab0bb75b) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Controller"; "Packet"; "Nettypes"; "Checksum"];
                      lib_pack = true;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "of_controller.ml"; });
               Executable
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "}Á{±\1273ú\030\021Òt\128MÂ'í";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
