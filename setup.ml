...
(* OASIS_START *)
(* DO NOT EDIT (digest: dd36bb76a79236d7c277c57caefdd5eb) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Controller"; "Packet"; "Checksum"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Controller"; "Packet"; "Ofswitch"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
                      lib_findlib_name = Some "openflow_mirage";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Manager"; "Nettypes"; "Channel"; "Flow"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
                      lib_findlib_name = Some "openflow_lwt";
                      lib_findlib_containers = [];
                      });
               Doc
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "S9m\2020\005\170\250O\139I\211\237\206\178\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
