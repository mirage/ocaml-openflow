...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26d39ab71a252b935f7faaa53fbe83ff) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Xen tests";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Flag
                 ({
               ...
               Executable
                 ({
                     cs_name = "learning_switch_mirage_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
               ...
               Executable
                 ({
                     cs_name = "basic_switch_mirage_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "¶b¶\131\158»¸ËÌ\000å\023Z¼!\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
