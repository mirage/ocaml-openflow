...
(* OASIS_START *)
(* DO NOT EDIT (digest: f3594f9aca8476215a598758ce81e9dd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "OpenFlow controller, switch and flowvisor implementation in pure OCaml";
          description = None;
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ofpacket"; "Ofcontroller"; "Ofsocket"];
                      lib_pack = true;
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "lib";
                      bs_compiled_object = Native;
                      bs_build_depends = [FindlibPackage ("re.str", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Flowvisor"; "Lldp"; "Flowvisor_topology"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
                      lib_findlib_name = Some "flv";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\205\242\155\\\000/\243\1843\196\132\189\0311\234e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
